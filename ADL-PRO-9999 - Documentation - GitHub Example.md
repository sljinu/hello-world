...
<html>
	<head>
		...
		<meta name="Company" content="IBM"/>

		<title>New Visio for Github</title>
		<script src="New Visio for Github_files/frameset.js" type="text/javascript" language="javascript"></script>
...
var g_FileList = new  Array(
 new FileEntry (1, 0, "Reverse Testing", "xaml_1.htm", "png_1.htm")
...
function CreateHLObj (hlNode)
{
	...
	<frameset id="frmstOuter" cols="237,*">
		<frame src="New Visio for Github_files/toolbar.htm" name="frmToolbar" id="frmToolbar" title="This frame contains tools for manipulating your drawing." frameborder="6" bordercolor="#999999" scrolling="no" marginheight="0" marginwidth="0" >
		<frame src="New Visio for Github_files/png_1.htm" name="frmDrawing" title="This frame contains the pages of your drawing." marginheight="10" marginwidth="10" onload="if (parent.isUpLevel) FramePageLoaded()" >

		<noframes>
			<body>

				<h1>New Visio for Github</h1>
				<ul>
				<li><a href="New Visio for Github_files/png_1.htm">Reverse Testing</a></li>
